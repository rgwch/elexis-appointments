Comme vous vous posiez certainement déjà la question : Non, il n'y a pas de cookies ici.
...
Certaines options, comme la consultation et l'annulation de vos rendez-vous existants, sont protégées par un deuxième niveau : vous recevrez un e-mail avec un lien d'accès lors de l'appel.
